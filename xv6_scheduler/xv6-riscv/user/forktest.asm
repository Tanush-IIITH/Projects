...
forktest(void)
{
  ...
  36:	3ee50513          	addi	a0,a0,1006 # 420 <set_nice+0xe>
  ...
  58:	41c50513          	addi	a0,a0,1052 # 470 <set_nice+0x5e>
  ...
  6e:	3c650513          	addi	a0,a0,966 # 430 <set_nice+0x1e>
  ...
  80:	3cc50513          	addi	a0,a0,972 # 448 <set_nice+0x36>
  ...
  b0:	3b450513          	addi	a0,a0,948 # 460 <set_nice+0x4e>
