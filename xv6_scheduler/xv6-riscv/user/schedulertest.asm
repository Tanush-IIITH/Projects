...
int main() {
  ...
  exit(0);
  20:	4501                	li	a0,0
  22:	2ec000ef          	jal	30e <exit>
      if (n < IO) {
  26:	4791                	li	a5,4
  28:	0497d463          	bge	a5,s1,70 <main+0x70>
  ...
  54:	fef758e3          	bge	a4,a5,44 <main+0x44>
      printf("Process %d finished\n", getpid());
  58:	336000ef          	jal	38e <getpid>
  5c:	85aa                	mv	a1,a0
  5e:	00001517          	auipc	a0,0x1
  62:	8a250513          	addi	a0,a0,-1886 # 900 <malloc+0x106>
  66:	6e0000ef          	jal	746 <printf>
      exit(0);
  6a:	4501                	li	a0,0
  6c:	2a2000ef          	jal	30e <exit>
        pause(200); // IO-bound process
  70:	0c800513          	li	a0,200
  74:	32a000ef          	jal	39e <pause>
  78:	b7c5                	j	58 <main+0x58>
